...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="51">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item d-flex flex-column flex-sm-row bg-white rounded h-100 p-4 p-lg-5">
                        ...
                        <div class="ms-sm-4">
                            ...
                            {{-- <h6 class="mb-3">Start from <span class="text-primary">$199</span></h6> --}}
                            <span>Equipo altamente especializado en resolver tus dudas y llevarte a la meta final de construcción de tu sitio web.</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="owl-carousel testimonial-carousel">
                        <div class="testimonial-item text-center">
                            ...
                            <p class="fs-5 fst-italic">Soy florista y mis ventas subieron ya que mis clientes ven mis servicios y entran en mi enlace de WhatsApp donde llevo a cabo sus pedidos</p>
                        ...
                        <div class="testimonial-item text-center">
                            ...
                            <p class="fs-5 fst-italic">Soy Quiropráctico y mi sitio web me ayudo bastante para que mis clientes conozcan mi ubicación, horarios, costos y catalogo de servicios que suelo manejar.</p>
                            <hr class="w-25 mx-auto">
                            <h5>Oscar pérez</h5>
                        ...
                        <div class="testimonial-item text-center">
                            ...
                            <p class="fs-5 fst-italic">Soy entrenador personal de gimnasio y mi sitio web les encanta a mis clientes ya que toda mi información de mis servicios esta a la mano y el sitio es bastante rápido.</p>
                            <hr class="w-25 mx-auto">
                            <h5>Daniel pineda</h5>
        ...
        <div class="container py-5">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-7 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <p class="mb-4">Contactanos y nos comunicaremos contigo a la brevedad posible, podremos responder a cualquier duda y ofrecerte el mejor servicio para volver realidad tus ideas en la construcción de tu sitio web.</p>
                    <form>
                        <div class="row g-3">
                            <div class="col-md-6">
    ...
    <div class="container-xxl pt-5 px-0 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container-xxl pt-5 px-0">
            <div class="bg-dark">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d60383.79608778333!2d-99.28176451152628!3d18.9319582433741!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85cdde499b22afad%3A0xc9b6bcb5b9b790a1!2sCuernavaca%2C%20Mor.!5e0!3m2!1ses-419!2smx!4v1671335338265!5m2!1ses-419!2smx" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
    </div>
    <!-- Map End -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom text-secondary" href="#">Constructorweb</a> Todos los derechos reservados 
                    </div>
                    <div class="col-md-6 text-center text-md-end">
                        <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                        Diseñado por <a class="border-bottom text-secondary" href="https://htmlcodex.com">Constructorweb</a>
                    </div>
                </div>
            </div>
        </div>
